...
class PredNet(Recurrent):
    ...
    # References
        ...
        - [Convolutional LSTM networks: a machine learning approach for precipitation nowcasting](http://arxiv.org/abs/1506.04214)
    ...
    def step(self, a, states):
        ...
        if not self.feedforward_only:
            outputs = {'i': {}, 'f': {}, 'o': {}, 'c': {}, '_c': {}, '_r': {}, 'Ahat': {}, 'A': {}, 'R': {}, 'E': {}, 'A_before_pool': {}}
        else:
            outputs = {'A': {}, 'E': {}, 'A_before_pool': {}}
        ...
        for l in reversed(range(self.nb_layers)):
            ...
            if not self.feedforward_only:
                ...
                outputs['_c'][l] = _c
                outputs['_r'][l] = _r
                outputs['c'][l] = self.conv_layers['c'][l].call(inputs)
        ...
        for l in range(self.nb_layers):
            if not self.feedforward_only:
                ...
                ahat = self.conv_layers['ahat'][l].call(K.zeros(a.shape, dtype=a.dtype))
            if l == 0:
    ...
    def get_filters(self):
        output = {'i': {}, 'f': {}, 'o': {}, 'c': {}, 'ahat': {}, 'a': {}}
        for l in range(self.nb_layers):
            output['i'][l] = self.conv_layers['i'][l].get_weights()[0]
            output['f'][l] = self.conv_layers['f'][l].get_weights()[0]
            output['o'][l] = self.conv_layers['o'][l].get_weights()[0]
            output['c'][l] = self.conv_layers['c'][l].get_weights()[0]
            output['ahat'][l] = self.conv_layers['ahat'][l].get_weights()[0]
            if l < self.nb_layers - 1:
                output['a'][l] = self.conv_layers['a'][l].get_weights()[0]
        return output

    def get_output_shapes(self):
        output = {'i': {}, 'f': {}, 'o': {}, 'c': {}, 'ahat': {}, 'a': {}}
        for l in range(self.nb_layers):
            output['i'][l] = self.conv_layers['i'][l].get_output_shapes()
            output['f'][l] = self.conv_layers['f'][l].get_weights()[0]
            output['o'][l] = self.conv_layers['o'][l].get_weights()[0]
            output['c'][l] = self.conv_layers['c'][l].get_weights()[0]
            output['ahat'][l] = self.conv_layers['ahat'][l].get_weights()[0]
